...
if __name__ == '__main__':
    ...
    # --------q------- Threshold  部分test/0
    #  Test set results:
    #  accuracy = 0.6232 recall = 0.5030 precision = 0.5497 f1 = 0.5253
    # -----------
    #  The ROC score on CHD dataset is 0.5318410420609455

    # 全部test/0   with batch_size=8
    # q1:0.15405279397964478,q3:0.21223744750022888,q0.29951442778110504
    # --------q------- Threshold
    #  Test set results:
    #  accuracy = 0.9259 recall = 0.5059 precision = 0.5170 f1 = 0.5114
    # -----------
    #  The ROC score on CHD dataset is 0.5590988151623267

    # 全部test/0   with batch_size=512
    # q1:0.3456259071826935,q3:0.41513174772262573,q0.5193905085325241
    # --------q------- Threshold
    #  Test set results:
    #  accuracy = 0.9364 recall = 0.5092 precision = 0.5621 f1 = 0.5344
    # -----------
    #  The ROC score on CHD dataset is 0.5910300363722496