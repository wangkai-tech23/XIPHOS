...
# import tensorflow.Summary as SummaryWriter
...
class Logger(object):
    ...
    def __init__(self, log_dir):
        """Create a summary writer logging to log_dir.""" #tf.summary.FileWriter()
        self.writer = tf.summary.create_file_writer(log_dir) #'./dagmm/logs'
        # tf.compat.v1.Summary.FileWriter()换成tf.compat.v1.Summary.create_file_writer()
...
#         #tf.summary.FileWriter()换成tf.summary.create_file_writer()
#
#     def scalar_summary(self, tag, value, step):
#         """Log a scalar variable."""
