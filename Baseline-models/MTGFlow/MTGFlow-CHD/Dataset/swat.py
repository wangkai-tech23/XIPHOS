...
def loader_SWat(root, batch_size, window_size, stride_size,train_split,label=False):
    ...
    image_path = os.path.join(data_root, "StatGraph/BaselineModels/data9_9_3-each27") # CHD_small # flower data set path
    print(image_path)
    ...
    test_dataset = datasets.ImageFolder(root=os.path.join(image_path, "val"), transform=transform)
