...
def load_extra_data(dataset_str,tag = 'train'): # 0,1,2,3,4
    ...
    # dataset_str = 4
    # for dataset_str in [1,2,3,4]:
    if 1:
        # node_path = '../../dataset-IVN/CHD/CHD_Split/Dataset50_40/0_'+tag+'/nodes/' + str(dataset_str) + '.csv'
        # edge_path = '../../dataset-IVN/CHD/CHD_Split/Dataset50_40/0_'+tag+'/edges/'+ str(dataset_str) + '/'
        #####
        node_path = '../../dataset-IVN/CHD/CHD_Split/Dataset50_40/'+tag+'/nodes/0_' + str(dataset_str) + '/'
    ...
    if 1:
        ...
        edge_path = '../../dataset-IVN/CHD/CHD_Split/Dataset50_40/'+tag+'/edges/0_'+ str(dataset_str) + '/'
