...
def load_normal_data(dataset_str,tag = 'train'): # 0,1,2,3,4
    ...
    # dataset_str = 0 #'../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+
    node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/' + tag + '/nodes/vector_0_' + str(dataset_str) + '.csv'

    idx_features_labels = np.genfromtxt(node_path, delimiter=',', dtype=np.dtype(np.float32))
    fanwei = int(len(idx_features_labels)/40)
    idx_features_labels = idx_features_labels[:fanwei*40]
    ...
    edge_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+ tag+ '/edges/0_' + str(dataset_str) + '/'
...
def load_data(dataset_str,tag = 'train'): # 0,1,2,3,4
    ...
    for dataset_str in [0,1,2,3,4,5]:
        if dataset_str==0:
            node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/' + tag + '/nodes/vector_' + str(dataset_str) + '_3.csv'
        else:
            node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/nodes/vector_' + str(dataset_str) + '.csv'
        # # edge_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/edges/'+ str(dataset_str) + '/'
    ...
    for dataset_str in [0,1,2,3,4,5]:
        # # node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/nodes/vector_' + str(dataset_str) + '.csv'
        if dataset_str==0:
            edge_path ='../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/edges/'+ str(dataset_str) + '_3/'
        else:
            edge_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/' + tag + '/edges/' + str(dataset_str) + '/'
        # edge_path ='../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/edges/'+ str(dataset_str) + '/'
...
def load_extra_data(dataset_str,tag = 'test'): # 0,1,2,3,4
    print('Start Loading data')
    # tag = 'test' #'train'
    feat=0;labels=0#初始化
    time_start = time.time()

    for dataset_str in [1,2,4,5,11,12,14,15]:
        if dataset_str>10:
            tag = 'train'
            node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/' + tag + '/nodes/0_' + str(dataset_str-10) + '/'
        else:
            node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/nodes/0_' + str(dataset_str) + '/'
        files = glob.glob(r'{}*.csv'.format(node_path))  # Read the folder
        num_png = len(files)  # Count the number of files in a folder
        print('文件个数：', num_png)
        idx_features_labels = 0
    ...
    for dataset_str in [1,2,4,5,11,12,14,15]:
        if dataset_str>10:
            tag = 'train'
            edge_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/' + tag + '/edges/0_' + str(dataset_str-10) + '/'
...
#     for dataset_str in [1,2,4,5]:
#
#         #####       '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/nodes/vector_' + str(dataset_str) + '.csv'
#         node_path = '../../dataset-IVN/ROAD-DEAL/ROAD_split/Dataset' + str(nnodes) + '/'+tag+'/nodes/0_' + str(dataset_str) + '/'
#         files = glob.glob(r'{}*.csv'.format(node_path))  # Read the folder
#         num_png = len(files)  # Count the number of files in a folder
#         print('文件个数：', num_png)
